...
from news_website.forms.user import PasswordForm, EmailForm, UsernameForm
from news_website.extensions import mail
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        from news_website.settings import Config
