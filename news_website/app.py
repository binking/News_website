...
from news_website.settings import ProdConfig
from news_website.assets import assets
from news_website.extensions import (
    bcrypt,
    cache,
    db,
    login_manager,
...
from news_website.views import public, user, news
