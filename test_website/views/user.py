...
from test_website.forms.user import PasswordForm, EmailForm, UsernameForm
from test_website.extensions import mail
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        from test_website.settings import Config
